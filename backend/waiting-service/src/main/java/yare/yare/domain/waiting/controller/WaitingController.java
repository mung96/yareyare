...
public class WaitingController {
    ...
    public ResponseDto<Void> testSub(){
        QueueStatusDto queueStatusDto = new QueueStatusDto(693L,"test_token",1234L,9876L);
        webSocketMessagingService.sendMessageToUser("84158567-d01d-4264-8244-d65ed57f1262",693L,queueStatusDto);
        return ResponseDto.success(CREATED);
    }
}
